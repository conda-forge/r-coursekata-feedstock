...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-coursekata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-coursekata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-coursekata
# for installing globally
pixi global install r-coursekata
```
...
It is possible to list all of the versions of `r-coursekata` available on your platform:
...
```
pixi search r-coursekata --channel conda-forge
```
